...
function teamFondos(_ref) {
  var client = _ref.client;
  function getById(_ref2) {
    var memberId = _ref2.memberId;
    return client({
      url: "/api/member-team-fondos/".concat(memberId),
      method: "get"
    });
  }
  function getAll() {
  ...
  function updateMember(_ref4) {
    var jwtToken = _ref4.jwtToken,
      memberId = _ref4.memberId,
      data = _ref4.data;
    var formattedData = {
